    ...
    <Card>
        ...
        <Form ref="form" :model="form" :label-width="100" :rules="formValidate" label-position="left">
            ...
            <FormItem label="处方记录" prop="content1">
                <Input v-model="form.content1" clearable type="textarea" :rows="4" maxlength="240" show-word-limit placeholder="请输入处方记录..." style="width:570px" />
            </FormItem>
            ...
            <FormItem label="特殊说明" prop="content2">
                <Input v-model="form.content2" clearable type="textarea" :rows="4" maxlength="240" show-word-limit placeholder="请输入特殊说明..." style="width:570px" />
            </FormItem>
            <Form-item class="br">
    ...
    methods: {
        ...
        handleSubmit() {
            this.$refs.form.validate(valid => {
                if (valid) {
                    addPrescribing(this.form).then(res => {
