          ...
          <Form-item
            ...
            >
              <Form-item label="" prop="title">
                <Input type="text" v-model="searchForm.title" placeholder="药品名称" clearable style="width: 150px"/>
              </Form-item>
...
<script>
import { getDrugList, deleteDrug } from "./api.js";
...
export default {
  ...
  methods: {
    ...
    getDataList() {
      this.loading = true;
        getDrugList(this.searchForm).then(res => {
          this.loading = false;
          if (res.success) {
